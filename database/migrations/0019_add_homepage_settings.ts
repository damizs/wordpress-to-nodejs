...
export default class extends BaseSchema {
  ...
  async up() {
    ...
    const settings = [
      ...
      {
        group: 'homepage_quickaccess',
        key: 'homepage_quickaccess_title',
        value: 'Acesso Rápido',
        type: 'text',
        label: 'Título Acesso Rápido',
      },
      {
        group: 'homepage_quickaccess',
        key: 'homepage_quickaccess_subtitle',
        value: 'Acompanhe as funções legislativa, fiscalizadora e deliberativa da Casa do Povo.',
        type: 'text',
        label: 'Subtítulo Acesso Rápido',
      },
      {
        group: 'homepage_quickaccess',
        key: 'homepage_quickaccess_badge',
        value: 'Navegação Rápida',
        type: 'text',
        label: 'Badge Acesso Rápido',
      },
      ...
      // Vereadores section
      {
        group: 'homepage_vereadores',
        key: 'homepage_vereadores_title',
        value: 'Mesa Diretora e Vereadores',
        type: 'text',
        label: 'Título Vereadores',
      },
      {
        group: 'homepage_vereadores',
        key: 'homepage_vereadores_subtitle',
        value: 'Composição da Mesa Diretora e parlamentares da Legislatura 2025-2028',
        type: 'text',
        label: 'Subtítulo Vereadores',
      },
      {
        group: 'homepage_vereadores',
        key: 'homepage_vereadores_badge',
        value: 'Legislatura 2025-2028',
        type: 'text',
        label: 'Badge Legislatura',
      },

      // Transparency section
      {
        group: 'homepage_transparency',
        key: 'homepage_transparency_title',
        value: 'Portal da Transparência',
        type: 'text',
        label: 'Título Transparência',
      },
      {
        group: 'homepage_transparency',
        key: 'homepage_transparency_subtitle',
        value: 'Acesse informações sobre a gestão pública municipal',
        type: 'text',
        label: 'Subtítulo Transparência',
      },

      // Diário Oficial section
      {
        group: 'homepage_diario',
        key: 'homepage_diario_title',
        value: 'Diário Oficial',
        type: 'text',
        label: 'Título Diário Oficial',
      },
      {
        group: 'homepage_diario',
        key: 'homepage_diario_subtitle',
        value: 'Fique sempre atualizado com as publicações e informações oficiais do município',
        type: 'text',
      ...
      },
      {
        ...
        value: 'Descubra as belezas e a cultura da nossa cidade',
        type: 'text',
      ...
      // Seals section
      {
        ...
        key: 'homepage_seals_title',
        value: 'Compromisso com a Transparência',
        type: 'text',
        label: 'Título Selos',
      },
      {
      ...
      {
        group: 'homepage_sections',
        key: 'section_quickaccess_visible',
        value: 'true',
        type: 'boolean',
        label: 'Mostrar Acesso Rápido',
      },
      {
        group: 'homepage_sections',
        key: 'section_esic_visible',
        value: 'true',
        type: 'boolean',
        label: 'Mostrar E-SIC',
      },
      {
        group: 'homepage_sections',
        key: 'section_transparency_visible',
        value: 'true',
        type: 'boolean',
        label: 'Mostrar Transparência',
      },
      {
        group: 'homepage_sections',
        key: 'section_vereadores_visible',
        value: 'true',
        type: 'boolean',
        label: 'Mostrar Vereadores',
      },
      {
        group: 'homepage_sections',
        key: 'section_diario_visible',
        value: 'true',
        type: 'boolean',
        label: 'Mostrar Diário Oficial',
      },
      {
        group: 'homepage_sections',
        key: 'section_instagram_visible',
        value: 'true',
        type: 'boolean',
