        ...
        <main>
          ...
          <div className="container">
            <div data-reveal="up" className="max-w-4xl mx-auto mb-8 card-modern p-4 flex flex-col sm:flex-row gap-3">
              ...
              {hasFilters && (
                <button onClick={() => { setSearchTerm(""); router.get("/pautas"); }} className="flex items-center justify-center gap-1.5 px-4 py-2.5 rounded-xl text-sm text-muted-foreground hover:text-foreground hover:bg-muted transition-colors">
                      ...
                      <div className="card-modern p-5 flex flex-col sm:flex-row sm:items-center gap-4 hover-lift">
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex flex-wrap items-center gap-2 mb-1.5">
                            <span className="px-2.5 py-0.5 bg-gold/10 text-gold rounded-full text-xs font-semibold uppercase tracking-wide">
