...
export default function PublicationShow({ publication, exportUrl }: Props) {
  ...
  return (
    ...
    >
      ...
      >
        <DocumentActionsPanel fileUrl={publication.file_url} exportUrl={exportUrl} className="mb-8" />
        ...
        {publication.description && (
          <RichContent html={publication.description} />
        )}
      </OfficialDocument>
    </PageLayout>
  );
