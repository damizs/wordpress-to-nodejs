...
export default function PautaForm({ pauta, sessionTypes = [] }: Props) {
  ...
  return (
    <AdminLayout title={isEditing ? 'Editar Pauta' : 'Nova Pauta'}>
      ...
      <PageHeader
        title={isEditing ? 'Editar Pauta' : 'Nova Pauta de Sessão'}
        description={
          isEditing
            ? 'Atualize a ordem do dia e os dados da pauta.'
            : 'Preencha os campos abaixo para registrar a ordem do dia da sessão.'
        }
        icon={ClipboardList}
