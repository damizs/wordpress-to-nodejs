  ...
  return (
    <AdminLayout title="Comissões">
      ...
      <div className="flex items-center justify-between mb-6">
        <p className="text-sm text-muted-foreground">Gerencie as comissões parlamentares</p>
        <CreateButton href="/painel/comissoes/criar">Nova Comissão</CreateButton>
      </div>
      ...
      <Table>
        ...
        <TBody>
          ...
          {committees.length === 0 && (
            <TableEmpty colSpan={6}>Nenhuma comissão cadastrada.</TableEmpty>
          )}
        </TBody>
      </Table>
